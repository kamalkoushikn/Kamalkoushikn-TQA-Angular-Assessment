// MongoDB init script - runs automatically when the container starts
// This seeds the database with sample astrology chart data

db = db.getSiblingDB('astrology');

// Drop existing collections to ensure clean state
db.charts.drop();

// Insert sample charts with full astrology data
...
print("✓ Successfully seeded astrology charts database");
